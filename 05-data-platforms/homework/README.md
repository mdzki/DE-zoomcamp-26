...
- __`.bruin.yml` and `pipeline.yml` (assets can be anywhere)__
...
- __`time_interval` - incremental based on a time column__
...
- __`bruin run --var 'taxi_types=["yellow"]'`__
...
- __`bruin run ingestion/trips.py --downstream`__
